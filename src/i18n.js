...
const resources = {
    es: {
        translation: {
            ...
            heroSubtitle: "Tu reemplazo definitivo de oficina de compras",
            heroDescription: "Bond es el reemplazo de la oficina de compras que encuentra y negocia las mejores ofertas, para que ahorres tiempo y dinero.",
            learnMore: "Saber más",
            ...
            // Benefits
            whyChooseBond: "¿Por qué elegir Bond como su reemplazo de oficina de compras?",
            experienceFuture: "Experimente el futuro de la gestión de compras con nuestra solución integral",
            saveCosts: "Ahorre hasta 30% en costos",
            saveCostsDesc: "Nuestro sistema de negociación y licitación inversa ofrece ahorros sustanciales.",
            reduceAdmin: "Reduzca el tiempo administrativo en 80%",
            reduceAdminDesc: "Nuestro reemplazo de oficina de compras maneja cada proveedor y proceso por usted.",
            eliminateTeam: "Elimine el equipo interno",
            eliminateTeamDesc: "Somos el reemplazo de oficina de compras que ha estado esperando.",

            // Process
            howItWorks: "Cómo funciona su reemplazo de oficina de compras",
            processDescription: "Simple, eficiente y efectivo—experimente la gestión de compras reinventada",
            submitRequest: "Enviar solicitud",
            submitRequestDesc: "Envíe un simple formulario de solicitud. Inicio rápido y sin complicaciones.",
            weSource: "Buscamos y negociamos",
            weSourceDesc: "Buscamos y negociamos los mejores precios por usted.",
            approve: "Aprobar y recibir",
            approveDesc: "Apruebe y reciba entregas sin gastos generales.",
